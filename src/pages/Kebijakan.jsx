            ...
            <footer className="w-full py-unit-lg bg-surface-container-lowest dark:bg-surface-container-low border-t border-outline-variant">
                <div className="flex flex-col md:flex-row justify-between items-center px-margin-mobile md:px-unit-lg max-w-container-max mx-auto gap-unit-md">
                    <div className="flex flex-col items-center md:items-start">
                        ...
                        <p className="text-on-surface-variant dark:text-on-surface-variant font-label-sm mt-1">© 2026 Quizzin. All rights reserved.</p>
                    </div>
                    <div className="flex gap-8">
                        <a className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary transition-colors font-label-sm" href="#">Features</a>
                        <a className="text-on-surface-variant dark:text-on-surface-variant hover:text-primary transition-colors font-label-sm" href="#">About</a>
                        <Link to="/privacy-policy" className="text-primary font-bold transition-colors font-label-sm">Privacy Policy</Link>
                    </div>
